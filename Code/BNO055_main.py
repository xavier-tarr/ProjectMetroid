...
# rst pin is GPIO pin 18 feel free to change to whatever you like
...
while True:
    ...
    file.write('X={0:0.2F}\tY={1:0.2F}\tZ={2:0.2F}'.format(x, y, z))
    file.write('\n')
    file.close()
    ...
    #print('Linear Accelerometer data in m/s^2:')
    #print('X={0:0.2F}\tY={1:0.2F}\tZ={2:0.2F}'.format(x, y, z))

    # Gravity acceleration data (i.e. acceleration just from gravity--returned
    # in meters per second squared):
    #x,y,z = bno.read_gravity()
    #print('Accelerometer data due to Gravity in m/s^2:')
    #print('X={0:0.2F}\tY={1:0.2F}\tZ={2:0.2F}'.format(x, y, z))
